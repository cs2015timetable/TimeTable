            ...
            <div id="form-div">
                ...
                <p class="room">
                    <%
                        ...
                        out.write(form.getNotifications(userId, 0));
                    %>
                </p>
                <div id='notes'>
                    <form  method='post' action='nConfirm.jsp'>
                        <div id='newNotes'>
                            <input id='group_button' type='submit' value='Clear Notifications'/>
                        </div>
                    </form>
                    <form method='post' action='oldNotifications.jsp'>
                        <div id='oldNotes'> 
                            <input id='meeting_button' type='submit' value='View old Notifications'/>
                        </div>
                    </form>
                </div>
            </div>
