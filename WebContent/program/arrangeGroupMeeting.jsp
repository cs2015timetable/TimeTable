  ...
  <% 
    ...
    <link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.10/themes/ui-lightness/jquery-ui.css" rel="stylesheet" type="text/css" />
	  ...
	  <body>
		...
		<div id="form-main">
		  <div id="form-div">
		  <form class="form" id="form1" action="arrangeGroupMeeting.jsp" method="post">
				<div id="meetImg">
			...
			if(session.getAttribute("login")!=null){
				...
				if(!isset(date)||!isset(groupId)||!isset(minutes)){
					...
					if(isset(startMinutes)&&isset(info)){
						meeting.insertMeeting(userId,true, groupId, date, startMinutes, mins, info);
						...
						out.write(meeting.formTime(userId,true,isset(week),groupId,date,mins));
					}
				}
			}%>
	  </form>
